...
<h3 class="description">Production time is over, let's see what we've got.</h3>
    ...
    <div id="projects_3D">
        ...
        <section class="a_project">
            <div>
                ...
                <p class="p_description">Ten days to create a short-film including all process of creation. It was a big challenge and an incredible experience. We were ten to create, recruit actors, find places, edit and promote the film.</p>
                <footer>
        ...
        <section class="a_project">
            <div>
                ...
                <p class="p_description">Slashe is a creative agency which create interactive contents for medias. I have done a three months internship as front-end developer.</p>
                <footer>
        ...
        <section class="a_project">
            <div>
                ...
                <p class="p_description">PatCorn is a library of short film or web series found on the Internet. Its purpose is to promote and reference awesome creators.</p>
                <footer>
        ...
        <section class="a_project">
            <div>
                ...
                <p class="p_description">CineQuest is an epic game where you have to find the name of a film based on a screenshot uploaded by players. Challenge, knowledge, conquest, everything will fit to moviegoers or neophyte.</p>
                <footer>
